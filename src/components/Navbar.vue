<template>
  <div style="display: inherit">
    ...
    <div id="nav" v-if="!grid.includes('md')" :class="'nav mobile ' + grid + (expanded ? ' shadow' : '')">
      <span style="margin: 0;" @click="expanded = !expanded">
        <svg class="svg-icon" viewBox="0 0 20 20" stroke="black" stroke-width="1" width="35" height="35">
      ...
      <transition name="nav">
        <span style="margin: 0;" @click="expanded = !expanded">
          <svg :class="{
                'rotate-90': expanded,
                'rotate-0': !expanded,
              }" class="menu" viewBox="0 0 100 70" width="35" height="35">
